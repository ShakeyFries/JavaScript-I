...
// 4. Give each of the objects the ability to speak their "name"s using the this keyword.

const parent = {
  "name": "Susan",
  "age": 70,
}
// const child = parent.push ([{name: George]});
// const grandchild = child.push ([name:Sam], [age: 30]);
